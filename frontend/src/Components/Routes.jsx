    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/nos-connaitre">
          ...
          />
          <Route path="mot-directeur" element={<PageDirecteur />} />
          <Route path="Histoire" element={<HistoirISTA />} />
          <Route
          ...
          <Route path="Chiffres clés" element={<ChiffresClés />} />
        </Route>
        <Route path="/ACTUALITES">
          <Route path="Actualités" element={<Actualités />} />
          <Route path="Appel d’offres" element={<AppelOffres />} />
        </Route>
      </Routes>
    </BrowserRouter>
  );
