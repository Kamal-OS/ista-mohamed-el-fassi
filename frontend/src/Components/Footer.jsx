        ...
        <div id="TopFooter" className='m-0 w-full h-[480px] '>
            <div className="flex justify-start gap-20">
                <div className="p-[80px] mt-16">
                    <img src={LogoOfppt} alt="Logo Ofppt" className='w-[327px] h-[102px]  ms-[200px]' />
                    <div  className='w-[327px] ms-[200px] mt-2  border-b-[1px] border-dashed' />
                    <div className="flex justify-start gap-9 ms-[220px]">
                        <img src="https://img.icons8.com/?size=100&id=8818&format=png&color=FFFFFF" className='size-10 mt-5' alt="SocialMediaIcone" />
                        <img src="https://img.icons8.com/?size=100&id=59813&format=png&color=FFFFFF" className='size-10 mt-5' alt="SocialMediaIcone" />
                        <img src="https://img.icons8.com/?size=100&id=phOKFKYpe00C&format=png&color=FFFFFF" className='size-10 mt-5' alt="SocialMediaIcone" />
                        <img src="https://img.icons8.com/?size=100&id=IuI5Yd3J3qcC&format=png&color=FFFFFF" className='size-10  mt-5 ' alt="SocialMediaIcone" />
                    </div>
                </div>
                <div  className='border-s-[0.1px] border-dashed mt-16 h-[370px]' />
                <div className="flex flex-col gap-7   p-[80px]">
                    <div>
                    <div className='font text-white text-xl font-bold '>Lient utiles</div>
                    <div className="border-b-4 w-[48px] mt-[7px]" />
                    </div>
                    <ul className='flex flex-col gap-5 text-white font'>
                        <li>Ofppt Site Officiel</li>
                        <li>MY WAY</li>
                        <li>Altissia/OFPPT-Langues</li>
                        <li>Scholar VOX</li>
                    </ul>
                </div>
                <div  className='border-s-[0.1px] border-dashed mt-16 h-[370px]' />
...
function BottomFooter() {
    return (
        <div id="BottoFooter" className='m-0 w-full h-[36px] '>
            <p className="font text-base text-white p-1.5 text-center">Institut Spécialisé de Technologie Appliquée Mohamed El Fassi Errachidia © 2025</p>
        </div>
    )
}
function Footer() {
