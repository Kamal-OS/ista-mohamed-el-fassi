      ...
      <div className="relative h-56 overflow-hidden md:h-[600px]">
        {images.map((image, index) => (
          <div
            ...
            />
            <div className="absolute top-40 right-0 p-7 w-[470px] h-[290px] bg-[#004A93] text-white p-6 overflow-hidden">
              <h3 className="text-[28px] font-bold mb-2">{image.titreImage}</h3>
              <p className="text-[16px] line-clamp-6 w-[360px]">
                {image.textImage}
              </p>
            </div>
          </div>
